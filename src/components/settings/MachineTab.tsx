                ...
                <tr key={m.id} className="hover:bg-blue-50/30 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-xs shrink-0 ${avatarColor(m.id)}`}>
                        {m.name.charAt(0)}
                      </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-wrap gap-1">
                      {m.categories.length === 0 ? (
                        ...
                        m.categories.slice(0, 3).map(({ category }) => (
                  ...
                  <td className="px-6 py-4">
                    {m.notes ? (
                      <button
                        onClick={() => setViewingNotes(m.notes)}
                        className="inline-flex items-center max-w-full px-2 py-0.5 rounded-md bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs transition-colors"
                      >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        onClick={() => { setDeleting(m); setDeleteDialogOpen(true); }}
